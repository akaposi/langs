...
open import stlc-sum.DepModel 
open import stlc-sum.InitialModel 

module stlc-sum.Induction {ℓ}{ℓ'}(D : DepModel In {ℓ}{ℓ'}) where
...
⟦ I.ttₗ ⟧tᵢ = D.ttₗ∙
⟦ I.ttₗ-[] γ i ⟧tᵢ = D.ttₗ-[]∙ ⟦ γ ⟧Sᵢ i
⟦ I.unit-η t i ⟧tᵢ = D.unit-η∙ ⟦ t ⟧tᵢ i
⟦ I.inlₗ a ⟧tᵢ = D.inlₗ∙ ⟦ a ⟧tᵢ
⟦ I.inlₗ-[] a γ i ⟧tᵢ = D.inlₗ-[]∙ ⟦ a ⟧tᵢ ⟦ γ ⟧Sᵢ i
⟦ I.inrₗ a ⟧tᵢ = D.inrₗ∙ ⟦ a ⟧tᵢ
⟦ I.inrₗ-[] a γ i ⟧tᵢ = D.inrₗ-[]∙ ⟦ a ⟧tᵢ ⟦ γ ⟧Sᵢ i
⟦ I.case+ t a b ⟧tᵢ = D.case+∙ ⟦ t ⟧tᵢ ⟦ a ⟧tᵢ ⟦ b ⟧tᵢ
⟦ I.case+[] t a b γ i ⟧tᵢ = D.case+[]∙ ⟦ t ⟧tᵢ ⟦ a ⟧tᵢ ⟦ b ⟧tᵢ ⟦ γ ⟧Sᵢ i
⟦ I.+-β₁ t a b i ⟧tᵢ = D.+-β₁∙ ⟦ t ⟧tᵢ ⟦ a ⟧tᵢ ⟦ b ⟧tᵢ i
⟦ I.+-β₂ t a b i ⟧tᵢ = D.+-β₂∙ ⟦ t ⟧tᵢ ⟦ a ⟧tᵢ ⟦ b ⟧tᵢ i
-- -- ⟦ I.+-η t a b i ⟧tᵢ = D.+-η∙ ⟦ t ⟧tᵢ ⟦ a ⟧tᵢ ⟦ b ⟧tᵢ i