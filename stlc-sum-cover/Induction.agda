...
open import stlc-sum-cover.DepModel 
open import stlc-sum-cover.InitialModel 

module stlc-sum-cover.Induction {ℓ}{ℓ'}(D : DepModel In {ℓ}{ℓ'}) where
...
⟦ I.exfalsoₗ a ⟧tᵢ = D.exfalsoₗ∙ ⟦ a ⟧tᵢ
⟦ I.exfalsoₗ-[] a γ i ⟧tᵢ = D.exfalsoₗ-[]∙ ⟦ a ⟧tᵢ ⟦ γ ⟧Sᵢ i
⟦ I.⊥ₗ-η t i ⟧tᵢ = D.⊥ₗ-η∙ ⟦ t ⟧tᵢ i
⟦ I.π-⇒0 b t i ⟧tᵢ = D.π-⇒0∙ ⟦ b ⟧tᵢ ⟦ t ⟧tᵢ i
⟦ I.inl a ⟧tᵢ = D.inl∙ ⟦ a ⟧tᵢ
⟦ I.inr b ⟧tᵢ = D.inr∙ ⟦ b ⟧tᵢ
⟦ I.caseₗ s l r ⟧tᵢ = D.caseₗ∙ ⟦ s ⟧tᵢ ⟦ l ⟧tᵢ ⟦ r ⟧tᵢ
⟦ I.inl-[] a γ i ⟧tᵢ = D.inl-[]∙ ⟦ a ⟧tᵢ ⟦ γ ⟧Sᵢ i
⟦ I.inr-[] b γ i ⟧tᵢ = D.inr-[]∙ ⟦ b ⟧tᵢ ⟦ γ ⟧Sᵢ i
⟦ I.caseₗ-[] s l r γ i ⟧tᵢ = D.caseₗ-[]∙ ⟦ s ⟧tᵢ ⟦ l ⟧tᵢ ⟦ r ⟧tᵢ ⟦ γ ⟧Sᵢ i
⟦ I.+-β₁ a l r i ⟧tᵢ = D.+-β₁∙ ⟦ a ⟧tᵢ ⟦ l ⟧tᵢ ⟦ r ⟧tᵢ i
⟦ I.+-β₂ b l r i ⟧tᵢ = D.+-β₂∙ ⟦ b ⟧tᵢ ⟦ l ⟧tᵢ ⟦ r ⟧tᵢ i
⟦ I.+-η s i ⟧tᵢ = D.+-η∙ ⟦ s ⟧tᵢ i
⟦ I.π-+⇒ s l r u i ⟧tᵢ = D.π-+⇒∙ ⟦ s ⟧tᵢ ⟦ l ⟧tᵢ ⟦ r ⟧tᵢ ⟦ u ⟧tᵢ i
⟦ I.π-+0 s l r i ⟧tᵢ = D.π-+0∙ ⟦ s ⟧tᵢ ⟦ l ⟧tᵢ ⟦ r ⟧tᵢ i
⟦ I.π-++ s l₁ r₁ l₂ r₂ i ⟧tᵢ = D.π-++∙ ⟦ s ⟧tᵢ ⟦ l₁ ⟧tᵢ ⟦ r₁ ⟧tᵢ ⟦ l₂ ⟧tᵢ ⟦ r₂ ⟧tᵢ i
⟦ I.π-⇒+ t l r i ⟧tᵢ = D.π-⇒+∙ ⟦ t ⟧tᵢ ⟦ l ⟧tᵢ ⟦ r ⟧tᵢ i