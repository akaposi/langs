...
[]-∘∙   ⟦ S ⟧ {Γ}{A}{aˢ}{Δ}{γˢ}{Θ}{δˢ}{Γ∙}{Δ∙}{Θ∙}{A∙} a γ δ = 
  ...
  subst2r (S.Tm∙ Θ∙ A∙) ((aˢ I.[ γˢ I.∘ δˢ ]=) ∙ I.[]-∘ aˢ γˢ δˢ)
    (sym (substComposite (S.Tm∙ Θ∙ A∙) ((aˢ I.[ γˢ I.∘ δˢ ]=) ∙ I.[]-∘ aˢ γˢ δˢ) (sym ((aˢ I.[ γˢ I.∘ δˢ ]=) ∙ I.[]-∘ aˢ γˢ δˢ)) _) ∙ -- {! S.[]-∘∙  a γ δ !}))
    {! substComposite  (S.Tm∙ Θ∙ A∙) (λ i → (aˢ I.[ γˢ ]=) i I.[ δˢ ]*)  (((aˢ I.[ γˢ I.∘ δˢ ]=) ∙ I.[]-∘ aˢ γˢ δˢ) ∙  (λ i → ((aˢ I.[ γˢ I.∘ δˢ ]=) ∙ I.[]-∘ aˢ γˢ δˢ) (~ i)))   (a S.[ γ ]∙ S.[ δ ]∙)!}  ∙ (sym (subst[]∙' {Γ∙ =  Δ∙} {A∙ = A∙} {Δ∙ =  Θ∙} {a∙ = (a S.[ γ ]∙)} (aˢ I.[ γˢ ]=) {γ = δˢ} {γ∙ = δ}))))
...
-- subst (S.Tm∙ Θ∙ A∙)
--       (((aˢ I.[ γˢ I.∘ δˢ ]=) ∙ I.[]-∘ aˢ γˢ δˢ) ∙
--        (λ i → ((aˢ I.[ γˢ I.∘ δˢ ]=) ∙ I.[]-∘ aˢ γˢ δˢ) (~ i)))
--       (a S.[ γ S.∘∙ δ ]∙)
--       ≡
--       subst (S.Tm∙ Θ∙ A∙) (λ i → (aˢ I.[ γˢ ]=) i I.[ δˢ ]*)
--       (a S.[ γ ]∙ S.[ δ ]∙)
